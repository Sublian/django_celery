...
class DocumentFileManager:
    ...
    def save_metadata(self, metadata, filename):
        ...
        metadata_path = self.get_storage_path(
            metadata_filename, 
            subfolder='metadata'
        )
    ...
    def _save_to_database(self, invoice_data, pdf_path):
        ...
        try:
            from .models import InvoiceDocument  # Importar aquí para evitar circular imports
    ...
    def cleanup_old_files(self, document_type=None):
        ...
        retention_days = settings.DOCUMENT_STORAGE['RETENTION_DAYS'].get(
            doc_type, 
            365
        )
