...
urlpatterns = [
    ...
    path(
        "partners/<int:pk>/delete/", PartnerDeleteView.as_view(), name="partner_delete"
    ),
    ...
    path(
        "company/<int:pk>/toggle/", company_toggle_active, name="company_toggle_active"
    ),
    path(
        "partners/wizard/step1/",
        PartnerWizardStep1.as_view(),
        name="partner_wizard_step1",
    ),
    path(
        "partners/wizard/step2/",
        PartnerWizardStep2.as_view(),
        name="partner_wizard_step2",
    ),
    path(
        "partners/wizard/step3/",
        PartnerWizardStep3.as_view(),
        name="partner_wizard_step3",
    ),
    path(
        "partners/wizard/finish/",
        PartnerWizardFinish.as_view(),
        name="partner_wizard_finish",
    ),
]
