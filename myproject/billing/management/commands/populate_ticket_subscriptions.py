            ...
            for customer_data in ticket_customers[:max_per_company]:
                ...
                try:
                    ...
                    if subscription:
                        ...
                        doc_type = "BOLETA" if customer_data['document_type'] != 'ruc' else "FACTURA"
                        self.stdout.write(f"✅ {subscription.code} - {template.name} - {doc_type}")
    ...
    def _create_subscription_lines(self, subscription, products, taxes):
        ...
        for i in range(line_count):
            ...
            price_unit = random.choice([
                Decimal('49.90'), Decimal('79.90'), Decimal('99.90'), 
                Decimal('129.90'), Decimal('159.90')
            ])
