...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--detail", action="store_true", help="Mostrar detalle de cada término"
        )
    ...
    def handle(self, *args, **options):
        ...
        for company in companies:
            ...
            for term in terms:
                ...
                if any(line.value == "percent" for line in term.lines.all()):
                    ...
                    has_balance = any(
                        line.value == "balance" for line in term.lines.all()
                    )
        ...
        if issues:
            ...
            self.stdout.write(f"\n💡 Recomendaciones:")
            self.stdout.write(
                f"   1. Ejecute: python manage.py populate_payment_terms --force"
            )
            self.stdout.write(
                f"   2. Revise términos sin líneas o con porcentajes incorrectos"
            )
        else:
            self.stdout.write(
