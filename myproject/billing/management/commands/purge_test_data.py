...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            if delete_all:
                ...
                products_deleted = taxes_deleted = series_deleted = journals_deleted = (
                    sequences_deleted
                ) = 0
    ...
    def delete_test_subscriptions(self):
        ...
        test_subscriptions = SaleSubscription.objects.filter(code__startswith="SUB")
    ...
    def delete_test_taxes(self):
        ...
        test_taxes = Tax.objects.filter(sequence__regex=r"^tax_(igv|exp)_\d+$")
    ...
    def delete_test_invoice_series(self):
        ...
        test_series = InvoiceSerie.objects.filter(name__contains="Serie")
    ...
    def delete_test_journals(self):
        ...
        test_journals = Journal.objects.filter(code__regex=r"^(INV|TKT)\d+$")
