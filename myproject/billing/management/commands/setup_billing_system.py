...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--skip-existing',
            action='store_true',
            help='Saltar datos que ya existen'
        )
        parser.add_argument(
            '--subscription-count',
            type=int,
    ...
    def handle(self, *args, **options):
        self.stdout.write('🚀 INICIANDO CONFIGURACIÓN COMPLETA DEL SISTEMA DE FACTURACIÓN\n')
        ...
        steps = [
            ...
            ('populate_subscriptions', f'📋 Poblando suscripciones ({subscription_count} por compañía)...'),
        ]
