...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "billing_type",
                    models.CharField(
                        choices=[("0", "Nubefact"), ("1", "OdooFacturacion")],
                        max_length=1,
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="salesubscription",
            index=models.Index(
                fields=["next_invoice_date"], name="billing_sal_next_in_f5cbe9_idx"
            ),
        ),
        migrations.AddField(
            ...
            name="company",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="billing.company"
            ),
        ),
        migrations.AddField(
            model_name="accountmove",
        ...
        migrations.AddField(
            ...
            name="journal",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="billing.journal"
            ),
        ),
        migrations.AddField(
            model_name="accountmove",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["catalog_type", "code"], name="billing_sun_catalog_f462a6_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="accountmove",
            index=models.Index(
                fields=["invoice_date"], name="billing_acc_invoice_eb71a1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="accountmove",
        ...
        migrations.AddIndex(
            model_name="accountmove",
            index=models.Index(
                fields=["sunat_state"], name="billing_acc_sunat_s_d3d14a_idx"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="advance_parameters", to="billing.product"
            ),
        ),
        migrations.AddField(
            model_name="systemparameter",
