...
def validate_dates_format(value: str, expected_format: str = '%d-%m-%Y') -> str:
    ...
    try:
        ...
        raise ValidationError(f"Fecha inválida: {value}. Formato esperado: {expected_format}")


def validate_currency_amount(amount: Any, min_value: float = 0, max_value: float = None) -> Decimal:
    """
