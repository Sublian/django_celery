...
async def test_logging_on_error():
    ...
    with patch.object(
        service_async, "_update_rate_limit_async", new_callable=AsyncMock
    ):
        with patch.object(service_async, "_async_init", new_callable=AsyncMock):
            with patch.object(service_async, "_get_endpoint_sync") as mock_get_endpoint:
                ...
                with patch.object(
                    service_async, "_check_rate_limit_sync", return_value=(True, 0)
                ):
                    with patch.object(
                        service_async, "_ensure_client"
                    ...
                    with patch.object(
                        ...
                        with patch.object(
                            ...
                            with patch.object(service_async, "service", mock_service):
                                ...
                                result = await service_async.generar_comprobante(
                                    valid_data
                                )
